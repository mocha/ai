...
**Communication Style:** All output follows `_shared/communication-style.md` — plain language, concise, actionable. Design presentations should lead with the decision the user needs to make, not with analysis. Apply the autonomous-fix rule during spec self-review (typos, contradictions, missing frontmatter get fixed inline without asking).
